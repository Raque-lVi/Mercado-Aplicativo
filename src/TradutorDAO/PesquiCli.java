...
public class PesquiCli {
    ...
    /* public List<Pessoa> ListaPessoapp  ()
    {
    String sql = "SELECT * FROM mercado . pessoa where nome LIKE '"+pesquisaCli.txNomePess.getText().toUpperCase().trim()+"%'";
    ...
    int hhh =(res.getInt("cpf"));
    
    if( ps.getCPFFalce()!= hhh){
    
    ps.setNome(res.getString("nome"));
    ps.setCpf(res.getString("cpf"));
    ...
    {
    String sql = "SELECT * FROM mercado . pessoa ";
