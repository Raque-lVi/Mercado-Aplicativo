...
public class DataDao {
    ...
    */
    ...
    String pa = (dia+"/ "+mes+"/ "+ano);
    dts.setDataC(pa);
    
    dts.setCodigo(UltResistroData());
    this.buscarData(dts);
}
    
    
 public int UltResistroData () {
     
 int valor = 0;
 
      String sql = "SELECT * FROM datas ORDER BY `datas`.`codigo` DESC";
      // datas retorno = null;
      ...
      PreparedStatement pst = Conexao.getPreparedStatement(sql);
       ...
       try { 
           ...
           res.last();
           valor = (res.getInt("codigo"));
           valor++;
         
              
      } catch (SQLException ex) {
          Logger.getLogger(PessoaDAO.class.getName()).log(Level.SEVERE, null, ex);
           JOptionPane.showMessageDialog(null,"Erro ao buscar a ultima data","ERRO,", JOptionPane.CLOSED_OPTION);
      }
  ...
  public boolean inserirData (datas dts) {
      ...
      String sql = "INSERT INTO datas (`codigo`,`dia`,`mes`,`ano`,`dataC`) VALUES (?,?,?,?,?);"; //o proprio app estara inserindo dados na tabela pessoa do xamp
      ...
      try {
          ...
          pst.setInt(2,dts.getDia());
          pst.setInt(3,dts.getMes());
          pst.setInt(4,dts.getAno());
          pst.setString(5,dts.getDataC());
